...
Para aprender a configurar y crear su proyecto de Experience Manager Screens en Experience Manager as a Cloud Service, vea [aquí](https://experienceleague.adobe.com/es/docs/experience-manager-screens/using/about-guide).
...
En la siguiente figura se definen los perfiles y sus funciones para Experience Manager Screens.
...
* **Guía de prácticas recomendadas para proyectos de Experience Manager Screens**
  ...
  Siga la **[Guía de prácticas recomendadas para proyectos de Experience Manager Screens](/help/using/about-guide.md)** diseñada para identificar obstáculos comunes al implementar un proyecto de Experience Manager Screens. El material se centra principalmente en las funciones y responsabilidades del proyecto. Se centra en el gráfico RACI para diferentes funciones, configuraciones de la plataforma Experience Manager y soporte y monitorización.

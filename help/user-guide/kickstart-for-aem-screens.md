...
Una vez que el reproductor ChromeOS esté activado, siga los pasos a continuación para registrar un dispositivo Chrome.
...
Todos los recursos del canal se están reproduciendo en el dispositivo Chrome.

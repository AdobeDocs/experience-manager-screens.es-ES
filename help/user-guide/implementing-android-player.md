...
El método ad hoc le permite instalar el último reproductor de Android (*.exe*). Visita [**Descargas del reproductor de AEM 6.5**](https://download.macromedia.com/screens/) página.
...
1. Descargue el paquete desde Google Play o desde [Descargas del reproductor de AEM Screens](https://download.macromedia.com/screens/) página
1. Obtenga las claves de plataforma del fabricante para obtener un *pk8* y *pem* file
...
1. Instalar ***aemscreensalign.apk*** uso de adb install en el dispositivo
...
Consulte [Ejemplo de política JSON](#example-json) así como una tabla que describe el uso de las distintas [Atributos de política](#policy-attributes).

1. Utilice un explorador de archivos MDM, ADB o Android Studio para soltar este archivo JSON de directiva en el *sdcard* en el dispositivo Android.
...
Además, debe consultar al proveedor de EMM acerca de la compatibilidad con AppConfig . Las más populares, como [VMWare Airwatch](https://docs.samsungknox.com/admin/uem/vm-configure-appconfig.htm), [Hierro móvil](https://docs.samsungknox.com/admin/uem/mobileiron2-configure-appconfig.htm), [SOTI](https://docs.samsungknox.com/admin/uem/soti-configure-appconfig.htm), [Blackberry UEM](https://docs.samsungknox.com/admin/uem/bb-configure-appconfig.htm), [IBM Maas360](https://docs.samsungknox.com/admin/uem/ibm-configure-appconfig.htm) y [Knox de Samsung](https://docs.samsungknox.com/admin/uem/km-configure-appconfig.htm) entre otros, admiten este estándar del sector.

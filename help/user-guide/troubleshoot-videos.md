...
# Configuración y resolución de problemas de reproducción de vídeo {#video-playback-configuration-and-troubleshooting}
...
## Recursos de video {#video-assets}
...
### Comprobando Perfil de vídeo {#checking-video-profile}
...
1. Cargue un vídeo de prueba y haga clic en **Aceptar** para comenzar la transcodificación.
...
1. Seleccione el vídeo y abra el cuadro de diálogo **Editar**. Abra la ficha **Perfiles**.

   >[!NOTE]
   >Seleccione diferentes perfiles (debe haber al menos un perfil &quot;H.264 de alta calidad&quot;).

### Comprobación del video en el reproductor web {#checking-the-video-in-the-web-player}
...
1. haga clic en **Flujo de trabajo de Inicio** en la barra de acciones para abrir el cuadro de diálogo **Ejecutar flujo de trabajo**.
...
1. Cambiar **directiva de reproducción automática** de **Predeterminado** a **no se requiere ningún gesto del usuario**

1. Reinicie el explorador Web y actualice el reproductor

>[!NOTE]
>
>Para obtener más información sobre las prácticas recomendadas para las experiencias de los usuarios con las nuevas políticas de reproducción automática en Chrome, consulte la documentación de *Cambios en la política de reproducción automática*, es decir, `https://developers.google.com/web/updates/2017/09/autoplay-policy-changes#webaudio`.
...
**Alineación de cubos en** XF de OS Siga los pasos a continuación para alinear los relojes en OSX:

1. Abra las preferencias **Fecha y hora** en cada cuadro OSX
1. Marcar **Establecer fecha y hora automáticamente**

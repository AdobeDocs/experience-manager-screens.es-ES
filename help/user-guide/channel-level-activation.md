...
>[!NOTE]
>
>Para obtener más información acerca del Reproductor de pantalla de AEM, consulte los siguientes recursos:Descargas del reproductor AEM ScreensTrabajando con el Reproductor de AEM Screens](working-with-screens-player.md)

...
1. Seleccione **Canal de pantalla dividida 1x2** en el asistente **Crear**.
...
1. **Añadir dos canales más a la carpeta Canal**
   ...
   1. Seleccione **Canal de secuencia** en el asistente **Crear** para crear un canal con el título **Zone1**.
...
1. **Añadir secuencias incrustadas (componente) al canal principal (MultiZone)**
   ...
   1. Seleccione la ruta de canal como **Zones** —> **Canales** —> **EmbeddedChannels** —> **Zone1**, como se muestra en la figura siguiente.
...
1. **Creación de una ubicación** 
   ...
   1. Escriba el **Título** como **SanJosé** y haga clic en **Crear**.
...
1. **Creación de una visualización**
   ...
   1. Escriba el **Título** como **Punto de encuentro** y haga clic en **Crear**.
...
1. **Asignación de Canales a la visualización**
   ...
   1. Introduzca la ruta del canal **MultiZone** en **Ruta de Canal**.
...
1. **Registro del dispositivo**
   ...
   1. Si el código de registro coincide con el código de la ficha Screens player **Device Registration**, haga clic en **Validate** en la barra de acciones.
      ![image](/help/user-guide/assets/multi-zone/multizone-img6.png)
   1. Introduzca el **Título** como **Chrome-Device1** y haga clic en **Registrar**.
   1. Seleccione **Asignar visualización** y seleccione la ruta a la configuración del dispositivo.

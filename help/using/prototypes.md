...
Normalmente, en esta fase se utiliza contenido de muestra o FPO. Ayuda al administrador del proyecto y a las partes interesadas clave a identificar cualquier brecha importante en el flujo de experiencia de usuario y cualquier problema de tiempo con la reproducción y los eventos de déclencheur relacionados.Esta fase también puede revelar posibles problemas con el posicionamiento, la escala y el tamaño del recurso.
...
>[!NOTE]
> Durante la fase de diseño de la experiencia de usuario, confirme que los datos extraídos por el diseño de la interfaz de usuario son compatibles.Por ejemplo, es probable que no todos los responsables de la toma de decisiones estén familiarizados con la estructura de datos de su base de datos de productos. Pueden elegir descriptores en su solución de experiencia de usuario que no sean campos principales en la capa de datos. Identificar con antelación dónde puede ser necesaria la manipulación de los datos y comunicarlos al cliente evita malentendidos más adelante. Si el cliente decide ampliar o modificar el etiquetado de la interfaz de usuario después de iniciar el desarrollo, se requiere más esfuerzo para dar cabida a los cambios.
